...
procedure Acao33();
procedure Acao34();
procedure Empilha(gObjeto: String);
function Desempilha(): String;
function PegaObjetoTopo(): String;
...
uses
  ...
  USintatico, USemantico, UMenu, Math;
...
var
  iRetorno: String;
begin
  {if gPilha1.Count > 0 then
    begin
      iRetorno := gLista.Create;
      gPilha1.Pop;
      Result := iRetorno;
    end
  else
...
begin
  //iTipo1 := gPilha1.Desempilha;
  //iTipo2 := gPilha1.Desempilha;
  {empilhaTipo(False);
  gTextoArquivo.Add('add' + #13#10);}
end;
